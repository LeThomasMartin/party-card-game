deck = [
    ...
    {"id": 25, "text": "Quel est ta positions sexuelle préférée ?", "category": "parler"},
    {"id": 26, "text": "Unpopular opinion sur le sex ", "category": "parler"},

    # DÉFI
    {"id": 27, "text": "Change un bout de vêtement avec la personne en face", "category": "défi"},
    {"id": 28, "text": "Avale un oeuf cru", "category": "défi"},
    {"id": 29, "text": "La personne de ton choix te fait un belly shot", "category": "défi"},
    {"id": 30, "text": "Drink un shot ! mystère", "category": "défi"},
    {"id": 31, "text": "Sort dehors deux bonnes minutes", "category": "défi"},
    {"id": 32, "text": "Laisse les gens fouiller dans ton cell 2 bonnes minutes", "category": "défi"},
    {"id": 33, "text": "Kiss ton partenaire en ayant une gorgée (Transfert la)", "category": "défi"},
    {"id": 34, "text": "Fais un tour de la bâtisse. Pas le droit de mettre un manteau ou des bottes", "category": "défi"},
